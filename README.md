...
## Introduction
Creating a Machine Learning model to predict the home prices in USA. 
We are going to use the dataset from Kaggle.com.
...
## Dataset Reference
* [Usa House price data](https://www.kaggle.com/datasets/vedavyasv/usa-housing) 
